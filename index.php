...
<header class="bg-primary text-white text-center py-5" data-aos="fade-down">
  <div class="container">
    <h1>Olá, eu sou <strong>Seu Nome</strong></h1>
    <p>Desenvolvedor Web</p>
    <a href="projetos.html" class="btn btn-light mt-3">Ver Projetos</a>
  </div>
</header>
